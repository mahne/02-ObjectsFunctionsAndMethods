...
def main():
    ...
    # even_better_draw_circles(rg.Point(100, 50), 15,11,'khaki3',5)
    # even_better_draw_circles(rg.Point(-200, 0), 10,15,'orchid4',3)

    even_better_draw_circles(rg.Point(132,48),22,30,'LawnGreen',20)
    better_draw_circles(rg.Point(-34,102),31)
    draw_circles(rg.Point(-211,-83))
    even_better_draw_circles(rg.Point(82,-64),20,7,'dark slate blue',6)
...
def even_better_draw_circles(point,r,number,color,thickness):
